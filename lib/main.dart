...
class MyApp extends StatelessWidget {
  @override
  Widget build(BuildContext context) => FlutterLayoutArtirle(<Example>[
        Example1(),
        Example2(),
        Example3(),
        Example4(),
...
class FlutterLayoutArtirle extends StatefulWidget {
  final List<Example> examples;

  FlutterLayoutArtirle(this.examples);

  @override
  _FlutterLayoutArticle createState() => _FlutterLayoutArticle();
}

class _FlutterLayoutArticle extends State<FlutterLayoutArtirle> {
  late int count;
  late Widget example;
  late String code;
  ...
  @override
  void didUpdateWidget(FlutterLayoutArtirle oldWidget) {
